#pragma checksum "C:\Users\Isomorphism\Documents\Repos\DungeonRpg\DungeonRpg\Pages\Client.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "11670f95d941e81b9174d8086c39b9087264a4e3"
// <auto-generated/>
...
#nullable restore
#line 18 "C:\Users\Isomorphism\Documents\Repos\DungeonRpg\DungeonRpg\Pages\Client.razor"
                     if (Map != null)
                    {
                        for (int y = -10; y < 10; y++)
                        {
...
#nullable restore
#line 23 "C:\Users\Isomorphism\Documents\Repos\DungeonRpg\DungeonRpg\Pages\Client.razor"
                                 for (int x = -10; x < 10; x++)
                                {
...
#nullable restore
#line 27 "C:\Users\Isomorphism\Documents\Repos\DungeonRpg\DungeonRpg\Pages\Client.razor"
...
#nullable restore
#line 35 "C:\Users\Isomorphism\Documents\Repos\DungeonRpg\DungeonRpg\Pages\Client.razor"
                                            }
                                            else if (tileId != 0)
                                            {
...
#nullable restore
#line 39 "C:\Users\Isomorphism\Documents\Repos\DungeonRpg\DungeonRpg\Pages\Client.razor"
                                                                           tileId
...
#nullable restore
#line 51 "C:\Users\Isomorphism\Documents\Repos\DungeonRpg\DungeonRpg\Pages\Client.razor"
                                                    break;
                                                case Npc npc:
...
#nullable restore
#line 56 "C:\Users\Isomorphism\Documents\Repos\DungeonRpg\DungeonRpg\Pages\Client.razor"
                                                    break;
                                                case Enemy enemy:
...
#nullable restore
#line 61 "C:\Users\Isomorphism\Documents\Repos\DungeonRpg\DungeonRpg\Pages\Client.razor"
                                                    break;
                                            }
                                        }
...
#nullable restore
#line 82 "C:\Users\Isomorphism\Documents\Repos\DungeonRpg\DungeonRpg\Pages\Client.razor"
                                                                                                              HandleKeyEvent
...
#line 112 "C:\Users\Isomorphism\Documents\Repos\DungeonRpg\DungeonRpg\Pages\Client.razor"
    ...
    private void HandleKeyEvent(KeyboardEventArgs args)
    {
        ...
        switch (args.Key)
        {
            case "w": WalkTo((Player.Position.X, Player.Position.Y - 1)); break;
            case "a": WalkTo((Player.Position.X - 1, Player.Position.Y)); break;
            case "s": WalkTo((Player.Position.X, Player.Position.Y + 1)); break;
            case "d": WalkTo((Player.Position.X + 1, Player.Position.Y)); break;
        }
    }
